...
def main(conds_, model_id, result_, path=data_path):
    ...
    # save model to file
    pickle.dump(model, open(model_save_path + "xgb_model_width_" + str(model_id) + ".pickle", "wb"))
...
if __name__ == "__main__":
    ...
    df_result.to_csv("../data/processed_data/variable_selection_width.csv", encoding="utf-8")
